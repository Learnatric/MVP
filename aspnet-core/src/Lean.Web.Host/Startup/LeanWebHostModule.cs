...
using Lean.Web.Startup.ExternalLoginInfoProviders;
using Lean.Email;

namespace Lean.Web.Startup
{
    [DependsOn(
        typeof(LeanWebCoreModule)
    )]
    public class LeanWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public LeanWebHostModule(
        ...
        public override void PreInitialize()
        {
            ...
            // Comment to use non-utc dates on back-end.
            Clock.Provider = ClockProviders.Utc;
        }

        public override void Initialize()
        {
            IocManager.RegisterAssemblyByConvention(typeof(LeanWebHostModule).GetAssembly());
        }
