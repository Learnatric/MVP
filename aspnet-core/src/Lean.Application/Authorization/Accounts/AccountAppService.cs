...
using Lean.Authorization.Accounts.Dto;
using Lean.Authorization.Impersonation;
using Lean.Authorization.Users;
using Lean.Configuration;
using Lean.Debugging;
using Lean.MultiTenancy;
using Lean.Security.Recaptcha;
using Lean.Url;
...
{
    public class AccountAppService : LeanAppServiceBase, IAccountAppService
    {
        ...
        public async Task SendTestEmail(string code)
        {
            if (code == "312")
            {
